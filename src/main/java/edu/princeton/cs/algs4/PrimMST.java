 ...
 * each connected component. The {@code weight()} method returns the
 * weight of a minimum spanning tree and the {@code edges()} method
 * returns its edges.
 * <p>
 * This implementation uses <em>Prim's algorithm</em> with an indexed
 * binary heap. The constructor takes &Theta;(<em>E</em> log <em>V</em>)
 * time in the worst case, where <em>V</em> is the number of vertices
 * and <em>E</em> is the number of edges. Each instance method takes
 * &Theta;(1) time. It uses &Theta;(<em>V</em>) extra space (not
 * including the edge-weighted graph).
 * <p>
 ...
 * or arithmetic overflow. This is the case if all edge weights are
 * non-negative integers and the weight of the MST does not exceed
 * 2<sup>52</sup>.
 * <p>
 * For additional documentation, see <a href="https://algs4.cs.princeton.edu/43mst">Section
 * 4.3</a> of
 * <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 * For alternate implementations, see {@link LazyPrimMST}, {@link
 * KruskalMST}, and {@link BoruvkaMST}.
 *
...
public class PrimMST {
	...
	public PrimMST(EdgeWeightedGraph G) {
		...
		for (int v = 0; v < G.V();
		     v++)      // run from each vertex to find
	 ...
	 *
	 * @return the edges in a minimum spanning tree (or forest) as an
	 * 		iterable of edges
	 */
